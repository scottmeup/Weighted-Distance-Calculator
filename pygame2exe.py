...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "FullpathCalculator.py"
 
        #Name of program
        self.project_name = "Weighted Distance Calculator"
        ...
        self.license = "Copyright Andrew Scott"
 
        #Auhor of program
        self.author_name = "Andrew Scott"
        self.author_email = "andrewscott.748@gmail.com"
        self.copyright = "Copyright (c) 20016 Andrew Scott."
